...
export default function Home() {
    ...
    return (
        <>
            <Layout headerStyle={2} footerStyle={3} breadcrumbTitle="Railway Freight">
                        ...
                        <div className="row">
                                ...
                                <div className="services-details__left">
                                    <div className="services-details__catagories-box">
                                        ...
                                        <ul className="services-details__catagories-list list-unstyled">
                                            ...
                                            <li>
                                                <Link href="shipping-freight.html">Shipping Freight<span
                                                        className="icon-next"></span></Link>
                                            </li>
                                            <li>
                            ...
                            <div className="col-xl-8 col-lg-7">
                                <div className="services-details__right">
                                    ...
                                    <h3 className="services-details__title-2">Railway Freight Service</h3>
